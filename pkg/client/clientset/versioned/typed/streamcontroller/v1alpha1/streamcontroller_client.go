...
import (
	...
	"github.com/projectriff/stream-controller/pkg/client/clientset/versioned/scheme"
...
func (c *ProjectriffV1alpha1Client) Streams(namespace string) StreamInterface {
