...
import (
	...
	scheme "github.com/projectriff/stream-controller/pkg/client/clientset/versioned/scheme"
...
func newStreams(c *ProjectriffV1alpha1Client, namespace string) *streams {
	return &streams{
		client: c.RESTClient(),
		ns:     namespace,
	}
